...
namespace Nocturne
{
    class Program
    {
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            var ztarget = LockedTargetSelector._lastTarget;
            if (ztarget != null) Render.Circle.DrawCircle(ztarget.Position, 125, Color.Lime, 7, true);
            ...
            if (Config.Item("ParanoiaDraw").GetValue<bool>() && R.IsReady())
            {
                ...
                var ValidTargets = EnemyList.Where(x => !x.InFountain() && !Orbwalking.InAutoAttackRange(x) && Vector3.Distance(ObjectManager.Player.ServerPosition, x.ServerPosition) < RRange());
                if (MYOrbwalker.CurrentMode != MYOrbwalker.Mode.Combo)
                {
                    switch (Config.Item("UseRType").GetValue<StringList>().SelectedIndex)
                    {
                        case 0:
                            ...
                            foreach (var target in Type1)
                            {
                                Render.Circle.DrawCircle(target.Position, 125, Color.Aquamarine, 7, true);
                            }
                            break;
                        case 1:
                            var Type2 = ValidTargets.Where(x => R.IsKillable(x));
                            foreach (var target in Type2)
                            {
                                Render.Circle.DrawCircle(target.Position, 125, Color.Aquamarine, 7, true);
                            }
                            break;
                        ...
                        case 2:
                            ...
                            if (Type3 != null) Render.Circle.DrawCircle(Type3.Position, 125, Color.Aquamarine, 7, true);
                            break;
                        case 3:
                            var Type4 = ValidTargets.OrderByDescending(i => i.Distance(ObjectManager.Player)).FirstOrDefault();
                            if (Type4 != null) Render.Circle.DrawCircle(Type4.Position, 125, Color.Aquamarine, 7, true);
                            break;
                        case 4:
                            var Type5 = ValidTargets.OrderBy(i => i.Health).FirstOrDefault();
                            if (Type5 != null) Render.Circle.DrawCircle(Type5.Position, 125, Color.Aquamarine, 7, true);
                            break;
                    }
                }
            }
        ...
        private static void LaneClear()
        {
            ...
            if (Config.Item("UseQFarm").GetValue<bool>() && Q.IsReady() && !MYOrbwalker.IsWaiting() && !ObjectManager.Player.IsWindingUp && !ObjectManager.Player.UnderTurret(true))
            {
                ...
                switch (Config.Item("QFarmType").GetValue<StringList>().SelectedIndex)
                {
                    case 0:
                        ...
                        {
                            if (QLine.MinionsHit >= 2) Q.Cast(QLine.Position);
                        }
                        break;
                    case 1:
                ...
                switch (Config.Item("UseRType").GetValue<StringList>().SelectedIndex)
                {
                    case 0:
                        ...
                        if (targetR != null && targetR.IsValidTarget() && (targetR.Health / ObjectManager.Player.GetAutoAttackDamage(targetR) <= Config.Item("UseRType1").GetValue<Slider>().Value))
                        {
                            ...
                            R.Cast();
                            Utility.DelayAction.Add(50, () => R.CastOnUnit(targetR));
                        }
                        break;
                    case 1:
                        ...
                        if (targetR2 != null && targetR2.IsValidTarget())
                        {
                            ...
                            R.Cast();
                            Utility.DelayAction.Add(50, () => R.CastOnUnit(targetR2));
                        }
                        break;
                    case 2:
                        ...
                        if (targetR3 != null && targetR3.IsValidTarget())
                        {
                            ...
                            R.Cast();
                            Utility.DelayAction.Add(50, () => R.CastOnUnit(targetR3));
                        }
                        break;
                    case 3:
                        ...
                        if (targetR4 != null && targetR4.IsValidTarget())
                        {
                            ...
                            R.Cast();
                            Utility.DelayAction.Add(50, () => R.CastOnUnit(targetR4));
                        }
                        break;
                    case 5:
                        ...
                        if (targetR5 != null && targetR5.IsValidTarget())
                        {
                            ...
                            R.Cast();
                            Utility.DelayAction.Add(50, () => R.CastOnUnit(targetR5));
                        }
                        break;
                }
            } 
